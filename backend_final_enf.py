...
- ANDEG es Asociación Nacional de Empresas Generadoras.
- Asocapitales es la Asociación de Ciudades Capitales.
NUEVOS DESARROLLOS:
...
- 2026 empezó con la noticia de que el Gobierno del presidente de Estados Unidos, Donald Trump, capturó a Nicolás Maduro como parte de una nueva doctrina Monroe dentro de Latinoamérica. 
...
- EL 8 de enero de 2026, El Ministerio de Minas y Energía planteó, a través de un proyecto de decreto para comentarios, un cargo transitorio de $8 por kilovatio hora a toda la demanda de la red eléctrica de Colombia. La finalidad de este incremento sería atender las deudas de la empresa de servicios públicos del Caribe, Air-e, que actualmente se encuentra intervenida. Según el proyecto¿, de manera temporal y mientras la Comisión de Regulación de Energía y Gas (Creg) reglamenta la confiabilidad para la mitigación del riesgo sistémico, el Administrador del Sistema de Intercambios Comerciales (ASIC) deberá recaudar, entre la demanda del Sistema Interconectado Nacional (SIN), un valor de $8 por kilovatio-hora, como un valor complementario en el componente de restricciones. Según el proyecto de resolución, por esta vía se cobraría la mitad de una abultada deuda de Air-e con el sector eléctrico, que al cierre de diciembre cerró en $2,5 billones. Dentro de la memoria justificativa de este proyecto de ley el Gobierno Nacional finalmente acepta que en el país actualmente se está presentando una importante crisis en el sector energético, a causa de la situación financiera de la empresa Air-e. Con la publicación del borrador, el Ministerio abrió un periodo de cuatro días calendario para recibir comentarios de la ciudadanía y de los agentes del sector. Finalizado ese plazo, la Comisión de Regulación de Energía y Gas (CREG) y el Ministerio definirán si el cobro se adopta, bajo qué condiciones y por cuánto tiempo. El ministro de Minas y Energía, Edwin Palma, aseguró que el problema energético del Caribe no es solo de los costeños, sino que es un problema nacional.
- El 8 de enero de 2026, desde la Liga Nacional de Usuarios de Servicios Públicos, su vocero en la región Caribe, Norman Alarcón, calificó como "absolutamente inaceptable para los usuarios de Colombia" la propuesta de resolución del MinMinas con la que buscan que los usuarios, tanto personas en sus residencias como empresas, paguen un aumento en su tarifa de energía para cubrir la billonaria deuda que tiene la comercializadora Air-e
