...
- EL 8 de enero de 2026, El Ministerio de Minas publicó un borrador de resolución con el que buscará que los usuarios, tanto personas en sus residencias como empresas, paguen un aumento en su tarifa de energía para cubrir la billonaria deuda que tiene la comercializadora Air-e con el mercado de energía mayorista y con los transmisores de energía, empresa intervenida por el Gobierno desde septiembre de 2024. Según el proyecto, que estará disponible hasta el 22 de enero del 2026, de manera temporal y mientras la Comisión de Regulación de Energía y Gas (Creg) reglamenta la confiabilidad para la mitigación del riesgo sistémico, el Administrador del Sistema de Intercambios Comerciales (ASIC) deberá recaudar, entre la demanda del Sistema Interconectado Nacional (SIN), un valor de $8 por kilovatio-hora, como un valor complementario en el componente de restricciones. Según el proyecto de resolución, por esta vía se cobraría la mitad de una abultada deuda de Air-e con el sector eléctrico, que al cierre de diciembre cerró en $2,5 billones.Dentro de la memoria justificativa de este proyecto de ley el Gobierno Nacional finalmente acepta que en el país actualmente se está presentando una importante crisis en el sector energético, a causa de la situación financiera de la empresa Air-e. 
"""
TERM_INDUSTRIA = {
    "tarifas energéticas",
